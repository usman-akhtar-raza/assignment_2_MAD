...
class DashboardScreen extends StatelessWidget {
  final List<Map<String, String>> products = [
    {'name': 'Ficas', 'price': '\$12', 'image': 'assets/ficas.png'},
    {'name': 'Cactus', 'price': '\$15', 'image': 'assets/cactus.png'},
    {'name': 'Samantha', 'price': '\$18', 'image': 'assets/samantha.png'},
    {'name': 'Alovera', 'price': '\$10', 'image': 'assets/alovera.png'},
  ];

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('What Kind of Plants You Want')),
            ...
            child: Card(
              child: Column(
                children: [
                  ...
                  Text(product['price']!, style: TextStyle(fontSize: 16, color: Colors.green)),
                ],
              ),
            ),
          );
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text('Regular Price: ${product['price']}', style: TextStyle(fontSize: 18, color: Colors.green)),
            SizedBox(height: 20),
            ElevatedButton(
              onPressed: () {},
              child: Text('Buy Now'),
